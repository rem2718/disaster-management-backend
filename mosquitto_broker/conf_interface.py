...
token, dev_name, dev_password, broker_ip = None, None, None, None
...
def submit(name, password, mac, type, result_label, broker=None):
    global dev_name, dev_password, broker_ip
    dev_name, dev_password, broker_ip = name, password, broker
    headers = {
...
def conf_interface():
    ...
    root.mainloop()
    return dev_name, dev_password, broker_ip
